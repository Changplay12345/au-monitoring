...
## 13) Features Highlights

### Interactive Timetable
- **All Days View**: Complete weekly schedule
- **Day View**: Individual day schedule with swimlane layout
- **Smooth Animations**: Slide transitions between views
- **Course Details**: Click courses for section information
- **Real-time Updates**: Seat availability and status
...
- Download TQF and USR specifications
