...
export function GCPSidebar({ isOpen, onClose, activeItem = 'Course Monitoring', onItemClick, onNavigate }: GCPSidebarProps) {
  ...
  const pageUrls: Record<string, string> = {
    ...
    'Course Cross Checker': '/course-cross-checker-app',
  ...
  const productItems: SidebarItem[] = [
    ...
    { icon: <GraduationCap className="w-5 h-5" />, label: 'Course Cross Checker', hasChevron: true, href: pageUrls['Course Cross Checker'] },
