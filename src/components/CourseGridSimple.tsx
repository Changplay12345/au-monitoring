...
export function CourseGridSimple() {
  ...
  // Group by day
  const groupedByDay: Record<string, NormalizedCourse[]> = {}
  DAYS.forEach(day => {
                ...
                {groups.map((course, cIdx) => (
                  <CourseBlock
                    ...
                    course={{
                      ...
                      seatUsed: course.seatUsed ?? 0,
                      seatLeft: course.seatLeft ?? 0,
                      startTime: course.start,
                      endTime: course.end,
                      day: course.day,
                      instructor: course.instructor,
                    }}
                    startMin={timeToMinutes(course.start)}
                    spanMin={timeToMinutes(course.end) - timeToMinutes(course.start)}
